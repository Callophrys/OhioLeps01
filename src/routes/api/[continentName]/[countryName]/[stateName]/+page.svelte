...
<DoubledContainer>
            ...
            <div class="space-y-2 max-w-44">
                ...
                >
                    ...
                    <ul class="list-disc ml-2">
                        <li>
                            Left-click mouse and drag to create sets of counties
                        </li>
                        <li>
                            Press and hold down control key while clicking or
                            dragging to add or remove
                        </li>
                        <li>
                            Press and hold both control and shift keys to add or
                            remove entire regions of counties
                        </li>
                    </ul>
    ...
    <svelte:fragment slot="rightTail"
