...
<div>
    ...
    <div>
        <label>
            ...
            <button class="btn variant-soft w-48 justify-between" use:popup={popupComboboxSiteDate}>
...
<div class="content">
    ...
    <div>updated at {data.site.updatedAt ? formatDate(data.site.updatedAt.toISOString()) : ''}</div>
</div>
