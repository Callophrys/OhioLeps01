        ...
        <div class="content space-y-2">
                ...
                {#if $page.data?.user && ($page.data.user.role === ROLE.SUPER || $page.data.user.role === ROLE.ADMIN)}
                    <div class="pl-4">
                        ...
                        {#if currentSite?.personAddress2}
                            <div>
                                Address2: {currentSite?.personAddress2 ?? ""}
                            </div>
                        {/if}
            ...
            <div>
                ...
                <div class="pl-4">
                    ...
                    <div>
                        longitudeStart: {currentSite?.longitudeStart ?? ""}
                    </div>
            ...
            <div>
                ...
                {#if currentSite?.altPerson && $page.data?.user && ($page.data.user.role === ROLE.SUPER || $page.data.user.role === ROLE.ADMIN)}
                    <div class="pl-4">
                        <div>
                            Address: {currentSite?.altPersonAddress ?? ""}
                        </div>
                        {#if currentSite?.altPersonAddress2}
                            <div>
                                Address2: {currentSite?.altPersonAddress2 ?? ""}
                            </div>
                        {/if}
            ...
            <div>
                <div>
                    Other Participants: {currentSite?.otherParticipants ?? ""}
                </div>
            ...
            <div>
                ...
                <ul class="pl-4">
                    {#each data.site.siteStatuses as siteStatus}
                        <li>
                            {siteStatus.year}: {siteStatus.statusCode
                                .description ?? ""}
                        </li>
                    {/each}
                </ul>
            ...
            <div>
                ...
                <ul class="pl-4">
                    {#each Array.from(data.site.sections).sort((a: Section, b: Section) => a.sectionIndex - b.sectionIndex) as section}
                        <li>
                            {section.labelLong}: {section.description ?? ""}
                        </li>
                    {/each}
                </ul>
            </div>
            ...
            {#if $page.data?.user && ($page.data.user.role === ROLE.SUPER || $page.data.user.role === ROLE.ADMIN || $page.data.user.role === ROLE.REVIEWER)}
                <div>
                    ...
                    <div class="pl-4 flex flex-row space-x-8">
                        <div>
                            <div>
                                Created at: {data.site?.createdAt
                                    ? formatDate(
                                          new Date(
                                              data.site.createdAt,
                                          ).toISOString(),
                        ...
                        <div>
                            <div>
                                Last Updated at: {data.site?.updatedAt
                                    ? formatDate(
                                          new Date(
                                              data.site.updatedAt,
                                          ).toISOString(),
                            ...
                            <div>
                                Last Updated by: {data.site.updatedBy
                                    ?.lastFirst ?? ""}
                            </div>
                        </div>
                    </div>
            ...
            {#if $page.data?.user}
                ...
                {#if $page.data.user.role === "SUPER" || $page.data.user.role === "ADMIN" || $page.data.user.role === "ENTRY"}
                    <button
                        ...
                        ><span class="text-success-400">✚</span>&nbsp;Add
                        observations date</button
                    >
                {/if}
            {/if}
            <button
