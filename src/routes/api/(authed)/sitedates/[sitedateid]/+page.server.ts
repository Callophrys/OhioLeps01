...
export const actions: Actions = {
    createSiteDate: async ({ request, locals }) => {
        ...
        const siteDate = {
            ...
            startTime: (String(startTimeDate) === 'null' ? null : startTimeDate) as Date | null,
            endTime: (String(endTimeDate) === 'null' ? null : endTimeDate) as Date | null,
            ...
            weather1: (String(formData.get('weather1')) === 'null' ? 'U' : String(formData.get('weather1'))) as Weather,
