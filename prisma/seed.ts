 ...
 */
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section1
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.siteid = s.id join section t on s.id = t.id
where t.sectionIndex = 1 and o.section1 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section2
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 2 and o.section2 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section3
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 3 and o.section3 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section4
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 4 and o.section4 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section5
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 5 and o.section5 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section6
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 6 and o.section6 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section7
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 7 and o.section7 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section8
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 8 and o.section8 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section9
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 9 and o.section9 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section10
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 10 and o.section10 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section11
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 11 and o.section11 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section12
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 12 and o.section12 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section13
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 13 and o.section13 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section14
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 14 and o.section14 is not null;
`;
await db.$executeRaw`
insert into sectionObservation (sectionId, sitedateobservationid, value)
select t.id, o.id, o.section15
from sitedateobservation o join sitedate d on d.id = o.sitedateid join site s on d.id = s.id join section t on s.id = t.id
where t.sectionIndex = 15 and o.section15 is not null;
`;
  ...
  await db.appConfig.createMany({
    data: [
      ...
      },
      {
        configName: "owner",
        configType: "string",
        configValue: "Template Owner",
        organizationId: templateOrganizationId,
      },
      {
        configName: "title",
        configType: "string",
        configValue: "Template Title",
        organizationId: templateOrganizationId,
      },
      {
        configName: "description",
        configType: "string",
        configValue: "Template Description",
        organizationId: templateOrganizationId,
      },
      {
        configName: "url",
      ...
      {
        configName: "showAnimatedIcon",
        configType: "boolean",
        configValue: "false",
        organizationId: templateOrganizationId,
      },
      {
        configName: "showAppBar",
        configType: "boolean",
        configValue: "true",
        organizationId: templateOrganizationId,
      },
      {
        configName: "showFooter",
        configType: "boolean",
        configValue: "false",
        organizationId: templateOrganizationId,
      },
      {
        configName: "showAvatar",
        configType: "boolean",
        configValue: "false",
        organizationId: templateOrganizationId,
      },
      {
        configName: "showStateProvince",
        configType: "boolean",
        configValue: "false",
        organizationId: templateOrganizationId,
      },
      {
        configName: "monitorStartYear",
        configType: "number",
        configValue: "1995",
        organizationId: templateOrganizationId,
      },
      {
        configName: "monitorSeason",
        configType: "object",
        configValue:
          '{"start":{"year":1995,"month":4,"day":1},"end":{"year":9999,"month":10,"day":1}}',
        organizationId: templateOrganizationId,
      },
      {
        configName: "initialDateRangeChoice",
        configType: "boolean",
        configValue: "true",
        organizationId: templateOrganizationId,
      },
      {
        configName: "initialHideUnmonitoredChoice",
        configType: "boolean",
        configValue: "true",
        organizationId: templateOrganizationId,
      },
      {
        configName: "initialUseLatinChoice",
        configType: "boolean",
        configValue: "true",
        organizationId: templateOrganizationId,
      },
      ...
      {
        configName: "attemptsBeforeDelay",
        configType: "number",
        configValue: "3",
        organizationId: templateOrganizationId,
      },
      ...
      {
        configName: "maxLoginFailuresDays",
        configType: "number",
        configValue: "30",
        organizationId: templateOrganizationId,
      },
  ...
  await db.appConfig.createMany({
    data: [
      ...
      },
      {
        configName: "owner",
        configType: "string",
        configValue: "Ohio Lepidopterists &copy;1995",
        organizationId: mainOrganizationId,
      },
      {
        configName: "title",
        configType: "string",
        configValue:
          "Learn Svelte(kit), Vite, TailwindCSS, SkeletonUI and Prisma",
        organizationId: mainOrganizationId,
      },
      {
        configName: "description",
        configType: "string",
        configValue:
          "Ohio Lepidopterists' Long-Term Monitoring of Ohio Butterflies",
        organizationId: mainOrganizationId,
      },
      {
        configName: "url",
    ...
    data: [
      {
        ...
        configType: "boolean",
        configValue: "true",
        organizationId: unauthOrganizationId,
      },
      {
        configName: "owner",
        configType: "string",
        ...
        create: [
          {
            ...
            lastName: "Person",
            passwordHash:
              "$2b$10$VN2pirOBvSfrOBL42kqzSOkmEF0Ib9O0x4NIdrD1umXq7b1bQmafe",
          ...
          },
          {
            ...
            lastName: "Snerd",
            passwordHash:
              "$2b$10$09GTBhmT0rC41GOoOvgw6.oGTbMEKZaxQ3spCEwRnmXjc6jxusoEC",
        ...
        create: [
          {
            ...
            lastName: "Admin",
            passwordHash:
              "$2b$10$/10FU9HawFQRclgobUUvieBzjFPEcgPHnxj6vFQXppZlCA.GllNSi",
          ...
          },
          {
            ...
            lastName: "Admin",
            passwordHash:
              "$2b$10$7E1py4B1Z/92b91WwvyyH.paGvSXu3woJyP39dchA0au4nzi.Zp6q",
        ...
        create: [
          {
            ...
            lastName: "User",
            passwordHash:
              "$2b$10$56GJhxPT4DjabrILVNuTyOhuiy9getA/XcTzMa3dkbK7mNZngk1Ie",
          ...
          },
          {
            ...
            lastName: "User",
            passwordHash:
              "$2b$10$EGaoT8pcITEpMpOi3L57.O6sxs.3.7Tzo/U/Ui6WhofIKRzy/i21a",
        ...
        create: [
          {
            ...
            lastName: "Entry",
            passwordHash:
              "$2b$10$LXMmdw48Q73UftCVFCmtm.oLRDQeO6hhdXXt.e3c3wXenSBATn95O",
          ...
          },
          {
            ...
            lastName: "Entry",
            passwordHash:
              "$2b$10$R3dg.kcIX6R9bMeTlwQ4texkjFMz.sdukrABksoRnIhGzQSSEjYb6",
        ...
        create: [
          {
            ...
            lastName: "Reviewer",
            passwordHash:
              "$2b$10$.WNNr6C6eeqcDzNX4HLsEOMWXsu0MAAGQya1wWLnl5Vi0n3Ct1jqe",
          ...
          },
          {
            ...
            lastName: "Reviewer",
            passwordHash:
              "$2b$10$7QJ786uW3jnDSslxwswNs.NikiI9VKoq2fC0jPHo0oIN/EADJjJf2",
