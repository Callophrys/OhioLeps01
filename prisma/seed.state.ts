...
export default async function () {
  ...
  const region1Id: number =
    stateRegions.find((r: any) => r.name === "Region1")?.id ?? 0;
  const region2Id: number =
    stateRegions.find((r: any) => r.name === "Region2")?.id ?? 0;
  const region3Id: number =
    stateRegions.find((r: any) => r.name === "Region3")?.id ?? 0;
  const region4Id: number =
    stateRegions.find((r: any) => r.name === "Region4")?.id ?? 0;
  const region5Id: number =
    stateRegions.find((r: any) => r.name === "Region5")?.id ?? 0;
